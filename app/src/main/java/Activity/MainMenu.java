...
//        recyclerViewCafe(ListImageCafe, horiz_scrl_animation, recyclerViewCafe, cafe_list);
...
////    }
////
////    public void recyclerViewCafe(Integer[] listImage, RecyclerView.ItemAnimator itemAnimator, RecyclerView recyclerViewMain, ArrayList<MainModels> arrayList) {
////        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MainMenu.this, LinearLayoutManager.HORIZONTAL, false);
////        arrayList = new ArrayList<>();
////        for (Integer integer : listImage) {
////            arrayList.add(new MainModels(integer));
...
////        recyclerViewMain.setLayoutManager(linearLayoutManager);
////        recyclerViewMain.setItemAnimator(itemAnimator);
////        recyclerViewMain.setAdapter(new CaffeAdapter(arrayList, MainMenu.this, R.layout.row_item_cafee));
//    }
}
